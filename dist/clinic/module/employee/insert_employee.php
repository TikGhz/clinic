<?
	if($_POST[u_idcard]=="" || $_POST[u_username]=="" || $_POST[u_password]==""){//ตรวจสอบค่าว่างทั้งหมด
		...
		echo "<script type='text/javascript'>window.location='index_panel.php?module=employee&file=form_employee';</script>";
	}else{
		...
		if(mysql_query($sql) or die (mysql_error())){
			$_SESSION[success]="เพิ่มข้อมูลพนักงานสำเร็จแล้ว";
