                    ...
                    <div class="panel panel-default panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            	...
                            	<form role="form" method="post" action="index_panel.php?module=employee&file=insert_employee" enctype="multipart/form-data" data-toggle="validator">
                                <div class="col-lg-6">
                                	<div class="well">
                                ...
                                <div class="col-lg-6">
                                	<div class="well">
                                        ...
                                        <div class="form-group">
                                        	<input type="hidden" name="u_type_id" value="4">
