            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">พนักงาน <a href="index_panel.php?module=employee&file=form_employee"><button type="button" class="btn btn-primary">เพิ่มข้อมูลพนักงาน</button></a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?
								$result_user=mysql_query("SELECT User_ID, User_Username, User_Title, User_Name, User_Lastname, User_Nickame, User_Birthday, User_Department, User_Tel FROM user WHERE User_Type_ID='4' ");
							?>
							...
							?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><? echo $User_Tel; ?></td>
                                            <td>
                                            <a href="index_panel.php?module=employee&file=show_employee&uid=<? echo $User_ID; ?>">
                                            	<button type="button" class="btn btn-info"><i class="fa fa-search-plus fa-fw"></i> เรียกดู</button>
                                            </a>
                                            <a href="index_panel.php?module=employee&file=edit_employee&uid=<? echo $User_ID; ?>">
                                            	<button type="button" class="btn btn-success"><i class="fa fa-pencil-square-o fa-fw"></i> แก้ไข</button>
                                            </a>
                                            <a href="index_panel.php?module=employee&file=delete_employee&uid=<? echo $User_ID; ?>">
